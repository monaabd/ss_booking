/* When starting app.js (the api server), this will check if the database has any items
   if not then it will add all the vehicles from the array (same as the import.json file)
*/

var mongoose = require('mongoose'),
  Vehicle = mongoose.model('Vehicle');

exports.autoLoadDb = function(){
  Vehicle.findOne({})
      .exec(function (err, collection) {
        if (collection === null){
          console.log("Database is empty, adding vehicles...");
          ...
          console.log("Database has items");
        }
  });
}
